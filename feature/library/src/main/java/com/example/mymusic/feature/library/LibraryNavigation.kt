...
fun NavController.navigateToLibrary(navOptions: NavOptions) = navigate(com.example.mymusic.feature.library.LIBRARY_ROUTE, navOptions)
...
fun NavGraphBuilder.libraryScreen(
    ...
    composable(
        route = com.example.mymusic.feature.library.LIBRARY_ROUTE
    ) {
